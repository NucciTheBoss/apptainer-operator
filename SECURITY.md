...
Security updates for the Apptainer charm will be released after vulnerabilities have been identified and fixed to
the `latest/edge`, `latest/candidate` and `latest/stable` release channels.
...
[gsa]: https://github.com/charmed-hpc/apptainer-operator/security/advisories/new
